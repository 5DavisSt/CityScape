 ...
 */
final class Version20240308154905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, amenity_id INT DEFAULT NULL, address_id INT DEFAULT NULL, prop_housing_type VARCHAR(255) NOT NULL, prop_nb_rooms INT NOT NULL, prop_sqm INT NOT NULL, prop_price INT NOT NULL, prop_nb_beds INT DEFAULT NULL, prop_nb_baths INT DEFAULT NULL, prop_nb_spaces INT DEFAULT NULL, prop_furnished TINYINT(1) DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_8BF21CDE12469DE2 (category_id), UNIQUE INDEX UNIQ_8BF21CDE9F9F1305 (amenity_id), UNIQUE INDEX UNIQ_8BF21CDEF5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
