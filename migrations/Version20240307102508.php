 ...
 */
final class Version20240307102508 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE picture ADD pic_property_id INT NOT NULL, ADD pic_file VARCHAR(255) NOT NULL, ADD pic_href VARCHAR(255) NOT NULL, ADD pic_alt VARCHAR(255) NOT NULL, ADD pic_caption VARCHAR(255) DEFAULT NULL, ADD pic_type INT NOT NULL, ADD pic_format VARCHAR(255) NOT NULL, ADD pic_width INT NOT NULL, ADD pic_height INT NOT NULL, ADD pic_size NUMERIC(10, 2) NOT NULL, DROP image_size, DROP created_at, DROP updated_at, CHANGE image_name pic_name VARCHAR(255) DEFAULT NULL');
